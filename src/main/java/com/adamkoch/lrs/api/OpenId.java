 ...
 * identifier in the manner of the OpenID "Identity URL". As the OpenID
 * 1.1 specification notes, OpenID itself"does not provide any mechanism to exchange profile information, though
 * Consumers of an Identity can learn more about an End User from any public, semantically interesting documents linked
 * thereunder (FOAF, RSS, Atom, vCARD, etc.)". In this way, FOAF and OpenID complement each other; neither provides a
 * stand-alone approach to online "trust", but combined they can address interesting parts of this larger problem
 * space."</p>
 *
 ...
 * @since 1.0.0
 */
public class OpenId implements InverseFunctionalIdentifier, UniformResourceIdentifier {
}
