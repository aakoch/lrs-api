...
/**
 * <a href="https://github.com/adlnet/xAPI-Spec/blob/master/xAPI-Data.md#inversefunctional">Inverse Functional Identifier</a>
 *
 * <p>An Inverse Functional Identifier (IFI) is a value of an Agent or Identified Group that is guaranteed to only ever refer to that Agent or Identified Group.</p>
 *
 * <pre>
 ...
 * | account | LrsObject | A user account on an existing system e.g. an LMS or intranet. |
 * </pre>
 *
